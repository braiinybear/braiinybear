     ...
     <section className="py-16 px-6 bg-gradient-to-b from-gray-50 to-gray-100">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-3 bg-gradient-to-r from-[var(--primary-main)] to-blue-600 bg-clip-text text-transparent">
              Our Work Areas
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {workAreas.slice(0, 4).map((area) => (
              <div
                key={area.id}
                className={`${area.color} border border-white/50 p-7 rounded-xl ${area.hoverColor} transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 text-center backdrop-blur-sm`}
              >
                <div
                  className={`${area.iconBg} w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-5 shadow-md`}
                >
                  {area.icon}
                </div>
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-4 py-2 rounded-lg hover:shadow-lg transition-all duration-300 hover:gap-3 font-medium"
                >
