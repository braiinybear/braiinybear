...
const Environment: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Environment | BraiinyBear Society</title>
        <meta
          name="description"
          content="Discover how BraiinyBear Society promotes sustainability through environmental education, eco-projects, and youth-led green initiatives."
        />
        <meta
          name="keywords"
          content="Environment, Sustainability, Green Schools, Tree Plantation, Eco Projects, Climate Education, BraiinyBear Society"
        />
      </Helmet>
